...
## robot_navigation (noetic) - 0.3.0-1

The packages in the `robot_navigation` repository were released into the `noetic` distro by running `/usr/bin/bloom-release robot_navigation -r noetic --edit` on `Fri, 11 Dec 2020 20:28:01 -0000`
...
## robot_navigation (melodic) - 0.3.0-1

The packages in the `robot_navigation` repository were released into the `melodic` distro by running `/usr/bin/bloom-release robot_navigation -r melodic --edit` on `Fri, 11 Dec 2020 19:56:59 -0000`
